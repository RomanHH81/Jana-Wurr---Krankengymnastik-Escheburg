...
export const prepared = [
  {
    title: "Termine",
    description: "Nach Vereinbarung – Öffnungszeiten bitte ergänzen.",
  },
  {
    title: "Unterlagen",
    description: "Rezept, Befunde oder Arztberichte mitbringen hilft beim Start.",
  },
  {
    title: "Mitbringen",
    description: "Bequeme Kleidung und gern ein kleines Handtuch.",
  },
];
